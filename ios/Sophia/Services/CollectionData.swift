...
nonisolated struct LearningCollection: Identifiable, Hashable, Sendable {
    let id: String
    let title: String
...
nonisolated enum CollectionData {
    static let allCollections: [LearningCollection] = [
        LearningCollection(
            id: "c_4kd6x78samcf",
        ...
        LearningCollection(
            id: "c_fgpg15z4amcf",
            title: "L'Or Noir et l'Économie du Monde",
            description: "Comprendre comment le pétrole a façonné la géopolitique et la science moderne.",
            coverAssetName: "collection_l_or_noir_et_l_economie_du_monde",
            courseIds: ["course_205_le_petrole_comme_source_de_conflits", "course_211_comment_fonctionne_le_prix_du_petrole", "course_18_la_grande_depression_1929", "course_71_qu_est_ce_que_l_effet_de_serre_vraiment", "course_54_la_decouverte_du_micro_ondes_par_acciden"]
        ),
        LearningCollection(
            id: "c_m3308zqbamcf",
        ...
        LearningCollection(
            id: "c_idrry5c5amcf",
            title: "Le Temps des Révoltes",
            description: "Les grandes bascules sociales et artistiques qui ont redéfini la liberté.",
            coverAssetName: "collection_le_temps_des_revoltes",
            courseIds: ["course_11_la_prise_de_la_bastille_1789", "course_14_la_commune_de_paris_1871", "course_132_bob_dylan_et_la_folk_protest", "course_152_la_liberte_guidant_le_peuple_delacroix", "course_17_la_revolution_russe_1917"]
        ),
        LearningCollection(
            id: "c_jbwuzn5zamcf",
            title: "L'Empire de la Peur",
            description: "Exploration des mécanismes de la peur à travers le suspense, la science et les crises mondiales.",
            coverAssetName: "collection_l_empire_de_la_peur",
            courseIds: ["course_146_hitchcock_et_le_suspense", "course_49_pourquoi_a_t_on_des_frissons", "course_22_la_crise_des_missiles_de_cuba_1962", "course_101_1984_george_orwell", "course_128_l_expressionnisme_munch_et_le_cri"]
        ),
        LearningCollection(
            id: "c_6870opqzamcf",
        ...
        LearningCollection(
            id: "g_mpzqlws4_0n3de",
            title: "Le Panthéon de la Grèce Antique",
            description: "Rencontrez les dieux et héros qui ont façonné l'imaginaire de la civilisation occidentale.",
            coverAssetName: "collection_le_pantheon_de_la_grece_antique",
            courseIds: ["course_161_la_naissance_des_dieux_grecs_cronos_zeus", "course_171_hercule_et_ses_12_travaux", "course_162_promethee_le_voleur_de_feu", "course_170_meduse_et_persee", "course_172_thesee_et_le_minotaure", "course_39_la_democratie_athenienne"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_1j8bg",
        ...
        LearningCollection(
            id: "g_mpzqlws4_382sp",
            title: "Défis écologiques du XXIe siècle",
            description: "Comprendre les enjeux climatiques et les solutions pour préserver notre planète.",
            coverAssetName: "collection_defis_ecologiques_du_xxie_siecle",
            courseIds: ["course_225_la_montee_des_eaux", "course_231_les_migrations_climatiques", "course_238_la_transition_energetique", "course_224_pourquoi_les_abeilles_sont_elles_vitales", "course_223_l_economie_circulaire", "course_235_l_eau_prochaine_source_de_conflits", "course_221_le_trou_de_la_couche_d_ozone_et_sa_gueri"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_4xiac",
            title: "Les dystopies littéraires",
            description: "Quand la littérature imagine le pire des mondes pour mieux questionner notre présent.",
            coverAssetName: "collection_les_dystopies_litteraires",
            courseIds: ["course_101_1984_george_orwell", "course_105_le_meilleur_des_mondes_aldous_huxley", "course_114_fahrenheit_451_bradbury", "course_102_la_ferme_des_animaux_george_orwell", "course_108_le_proces_kafka", "course_237_les_gafam_puissance_et_derives", "course_220_la_desinformation_et_les_fake_news"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_5kxjr",
            title: "Les tournants de la Guerre mondiale",
            description: "Plongez au cœur des affrontements décisifs qui ont marqué le milieu du XXe siècle.",
            coverAssetName: "collection_les_tournants_de_la_guerre_mondiale",
            courseIds: ["course_30_la_blitzkrieg_1940", "course_19_la_bataille_de_stalingrad_1942_1943", "course_20_hiroshima_et_nagasaki_1945", "course_37_la_shoah_mecanismes_d_un_genocide", "course_33_le_proces_de_nuremberg_1945_1946"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_6mt1o",
            title: "Les secrets du cerveau humain",
            description: "Explorez les mécanismes fascinants de la mémoire, du sommeil et de la conscience.",
            coverAssetName: "collection_les_secrets_du_cerveau_humain",
            courseIds: ["course_42_pourquoi_reve_t_on", "course_48_comment_fonctionne_la_memoire", "course_72_pourquoi_dort_on", "course_47_pourquoi_baille_t_on", "course_73_comment_le_cerveau_stocke_t_il_les_souve", "course_78_comment_fonctionne_l_electricite_dans_no"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_7r1yy",
            title: "Histoire du septième art",
            description: "Les grands réalisateurs et les mouvements qui ont révolutionné l'image animée.",
            coverAssetName: "collection_histoire_du_septieme_art",
            courseIds: ["course_142_charlie_chaplin_et_le_cinema_muet", "course_143_orson_welles_et_citizen_kane", "course_146_hitchcock_et_le_suspense", "course_144_la_nouvelle_vague_francaise", "course_145_kubrick_2001_l_odyssee_de_l_espace"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_8liwv",
            title: "L'épopée d'Ulysse",
            description: "Suivez le parcours du héros d'Ithaque à travers les mythes et les textes fondateurs.",
            coverAssetName: "collection_l_epopee_d_ulysse",
            courseIds: ["course_81_l_odyssee_homere", "course_173_ulysse_et_le_cyclope", "course_174_ulysse_et_les_sirenes", "course_82_l_iliade_homere"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_9zcsy",
        ...
        LearningCollection(
            id: "g_mpzqlws4_afvtk",
            title: "Grands noms du Théâtre",
            description: "De la tragédie grecque dramatique aux drames shakespeariens.",
            coverAssetName: "collection_grands_noms_du_theatre",
            courseIds: ["course_158_la_tragedie_grecque_et_le_theatre_antiqu", "course_159_le_theatre_de_shakespeare", "course_103_hamlet_shakespeare", "course_83_dipe_roi_sophocle", "course_84_antigone_sophocle"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_bonja",
        ...
        LearningCollection(
            id: "g_mpzqlws4_exr09",
            title: "Les maîtres de la musique",
            description: "De la rigueur de Bach à la fureur de Beethoven, l'évolution de l'harmonie.",
            coverAssetName: "collection_les_maitres_de_la_musique",
            courseIds: ["course_138_bach_et_la_musique_baroque", "course_135_mozart_enfant_prodige_et_vie_tragique", "course_136_beethoven_genie_et_surdite", "course_134_l_opera_de_verdi", "course_131_la_naissance_de_la_musique_electronique"]
        ),
        LearningCollection(
            id: "g_mpzqlws4_fit77",
