...
struct InAppSpecialOfferView: View {
            ...
            VStack(spacing: 0) {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 28) {
                        ...
                        VStack(spacing: 8) {
                            InAppSpecialFeature(text: "240 cours de culture g\u{00E9}n\u{00E9}rale")
                            InAppSpecialFeature(text: "Quiz interactifs illimit\u{00E9}s")
                            InAppSpecialFeature(text: "Nouveau contenu chaque semaine")
                        }
...
private struct InAppSpecialFeature: View {
    let text: String
